...
write: post: {
	...
	description: """
		...
		- **organization name or ID** – _See [View organizations](\(#DocsURL)/organizations/view-orgs/#view-your-organization-id) for instructions on viewing your organization ID._
