			...
			post: {
				...
				responses: {
					"200": {
						...
						content: "application/json": schema: $ref: "#/components/schemas/AnnotationEventList"
					}
			...
			get: {
				...
				responses: {
					"200": {
						...
						content: "application/json": schema: $ref: "#/components/schemas/AnnotationList"
					}
					"400": $ref: "#/components/responses/ServerError"
					"401": $ref: "#/components/responses/ServerError"
					"500": $ref: "#/components/responses/ServerError"
		...
		"/annotations/{annotationID}": {
			get: {
				...
				responses: {
					"200": {
						...
						content: "application/json": schema: $ref: "#/components/schemas/AnnotationEvent"
					}
					"400": $ref: "#/components/responses/ServerError"
					"401": $ref: "#/components/responses/ServerError"
			...
			put: {
				...
				requestBody: {
					...
					content: "application/json": schema: $ref: "#/components/schemas/AnnotationCreate"
				}
				responses: {
					"200": {
			...
			put: {
				...
				responses: {
					"200": {
						...
						content: "application/json": schema: $ref: "#/components/schemas/ReadStream"
					}
					"400": $ref: "#/components/responses/ServerError"
					"401": $ref: "#/components/responses/ServerError"
					"500": $ref: "#/components/responses/ServerError"
			...
			get: {
				...
				responses: {
					"200": {
						...
						content: "application/json": schema: $ref: "#/components/schemas/StreamList"
					}
					"400": $ref: "#/components/responses/ServerError"
					"401": $ref: "#/components/responses/ServerError"
					"500": $ref: "#/components/responses/ServerError"
	...
	components: {
		parameters: {
			AnnotationListFilter: {
				...
				schema: $ref: "#/components/schemas/AnnotationListFilter"
			}
			AnnotationDeleteFilter: {
				...
				schema: $ref: "#/components/schemas/AnnotationDeleteFilter"
			}
			StreamListFilter: {
				in:          "query"
				...
				schema: $ref: "#/components/schemas/StreamListFilter"
			}
			StreamDeleteFilter: {
				in:          "query"
				...
				required:    true
				description: "Stream to delete"
				schema: $ref: "#/components/schemas/StreamDeleteFilter"
			}
		}
		schemas: {
			...
			AnnotationEventList: {
				type: "array"
				items: $ref: "#/components/schemas/AnnotationEvent"
			}
			...
			StreamList: {
				type: "array"
				items: $ref: "#/components/schemas/ReadStream"
			}
			Stream: {
				type: "object"
				properties: {
