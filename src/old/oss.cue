...
oss: {
	...
	paths: {
		...
		"""
			...
			operationId:
				"GetHealth", tags: ["Health"], summary:
				"Get the health of an instance", servers: [{
				url: ""
			}], parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}], responses: {
			...
			operationId:
				"GetReady", tags: ["Ready"], summary:
				"Get the readiness of an instance at startup", servers: [{
				url: ""
			}], parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}], responses: {
			...
			get: {
				operationId:
					...
					"Check if database has default user, org, bucket", description:
					"Returns `true` if no default user, organization, or bucket has been created.", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}], responses: "200": {
				...
				operationId:
					...
					"Set up initial user, org and bucket", description:
					"Post an onboarding request to set up initial user, org and bucket.", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}], requestBody: {
			...
			get: {
				...
				operationId:
					...
					"Update an authorization to be active or inactive", requestBody: {
			...
			servers: [{
				...
				operationId:
					"GetLegacyAuthorizations", tags: ["Legacy Authorizations"], summary:
					"List all legacy authorizations", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "query"
					name: "userID"
				...
				operationId:
					"PostLegacyAuthorizations", tags: ["Legacy Authorizations"], summary:
					"Create a legacy authorization", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}], requestBody: {
			...
			servers: [{
				...
				operationId:
					"GetLegacyAuthorizationsID", tags: ["Legacy Authorizations"], summary:
					"Retrieve a legacy authorization", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "authID"
				...
				operationId:
					"PatchLegacyAuthorizationsID", tags: ["Legacy Authorizations"], summary:
					"Update a legacy authorization to be active or inactive", requestBody: {
				...
				operationId:
					"DeleteLegacyAuthorizationsID", tags: ["Legacy Authorizations"], summary:
					"Delete a legacy authorization", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "authID"
			...
			servers: [{
				...
				operationId:
					"PostLegacyAuthorizationsIDPassword", tags: ["Legacy Authorizations"], summary:
					"Set a legacy authorization password", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "authID"
			...
			post: {
				operationId:
					"PostSources", tags: ["Sources"], summary:
				...
				operationId:
					"GetSources", tags: ["Sources"], summary:
					"List all sources", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:          "query"
					name:        "org"
			...
			delete: {
				operationId:
					"DeleteSourcesID", tags: ["Sources"], summary:
				...
				operationId:
					"PatchSourcesID", tags: ["Sources"], summary:
				...
				operationId:
					"GetSourcesID", tags: ["Sources"], summary:
			...
			operationId:
				"GetSourcesIDHealth", tags: ["Sources"], summary:
				"Get the health of a source", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "path"
				name: "sourceID"
			...
			operationId:
				"GetSourcesIDBuckets", tags: [
				"Sources",
				"Buckets",
			], summary:
				"Get buckets in a source", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "path"
				name: "sourceID"
			...
			get: {
				operationId:
					"GetScrapers", tags: ["Scraper Targets"], summary:
					"List all scraper targets", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:          "query"
					name:        "name"
				...
				operationId:
					"PostScrapers", summary:
					"Create a scraper target", tags: ["Scraper Targets"], parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}], requestBody: {
			...
			get: {
				operationId:
					"GetScrapersID", tags: ["Scraper Targets"], summary:
					"Retrieve a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:       "path"
				...
				operationId:
					"DeleteScrapersID", tags: ["Scraper Targets"], summary:
					"Delete a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:       "path"
					name:     "scraperTargetID"
			...
			get: {
				operationId:
					"GetScrapersIDLabels", tags: ["Scraper Targets"], summary:
					"List all labels for a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
				...
				operationId:
					"PostScrapersIDLabels", tags: ["Scraper Targets"], summary:
					"Add a label to a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
			...
			operationId:
				"DeleteScrapersIDLabelsID", tags: ["Scraper Targets"], summary:
				"Delete a label from a scraper target", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "path"
				name: "scraperTargetID"
			...
			get: {
				operationId:
					"GetScrapersIDMembers", tags: ["Scraper Targets"], summary:
					"List all users with member privileges for a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
				...
				operationId:
					"PostScrapersIDMembers", tags: ["Scraper Targets"], summary:
					"Add a member to a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
			...
			operationId:
				"DeleteScrapersIDMembersID", tags: ["Scraper Targets"], summary:
				"Remove a member from a scraper target", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "path"
				name: "userID"
			...
			get: {
				operationId:
					"GetScrapersIDOwners", tags: ["Scraper Targets"], summary:
					"List all owners of a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
				...
				operationId:
					"PostScrapersIDOwners", tags: ["Scraper Targets"], summary:
					"Add an owner to a scraper target", parameters: [{
					$ref: "#/components/parameters/TraceSpan"
				}, {
					in:   "path"
					name: "scraperTargetID"
			...
			operationId:
				"DeleteScrapersIDOwnersID", tags: ["Scraper Targets"], summary:
				"Remove an owner from a scraper target", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "path"
				name: "userID"
			...
			operationId:
				"GetBackupKV", tags: ["Backup"], summary:
				"Download snapshot of metadata stored in the server's embedded KV store. Should not be used in versions greater than 2.1.x, as it doesn't include metadata stored in embedded SQL.", deprecated:
				true, parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}], responses: {
			...
			operationId:
				"GetBackupMetadata", tags: ["Backup"], summary:
				"Download snapshot of all metadata in the server", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:          "header"
				name:        "Accept-Encoding"
		...
		"""
			...
			operationId:
				"GetBackupShardId", tags: ["Backup"], summary:
				"Download snapshot of all TSM data in a shard", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:          "header"
				name:        "Accept-Encoding"
		...
		"""
			...
			operationId:
				"PostRestoreKV", tags: ["Restore"], summary:
				"Overwrite the embedded KV store on the server with a backed-up snapshot.", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "header"
			...
			operationId:
				"PostRestoreSQL", tags: ["Restore"], summary:
				"Overwrite the embedded SQL store on the server with a backed-up snapshot.", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "header"
				name: "Content-Encoding"
			...
			operationId:
				"PostRestoreBucketID", tags: ["Restore"], summary:
			...
			operationId:
				"PostRestoreBucketMetadata", tags: ["Restore"], summary:
				"Create a new bucket pre-seeded with shard info from a backup.", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}], requestBody: {
			...
			operationId:
				"PostRestoreShardId", tags: ["Restore"], summary:
				"Restore a TSM snapshot into a shard.", parameters: [{
				$ref: "#/components/parameters/TraceSpan"
			}, {
				in:   "header"
				name: "Content-Encoding"
			...
			requestBody: {
				...
				schema: {
					type:
						"string", description:
						"The header value specifies that the line protocol in the request body is encoded with gzip or not encoded with identity.", default:
						"identity", enum: [
						"gzip",
						"identity",
					]
		...
		"""
				...
				"204": description:
					"InfluxDB validated the request data format and accepted the data for writing to the bucket. `204` doesn't indicate a successful write operation since writes are asynchronous. See [how to check for write errors](https://docs.influxdata.com/influxdb/v2.1/write-data/troubleshoot).", "400": {
					description:
		...
		"""
			...
			OnboardingResponse: {
				...
				properties: {
					...
					url: {
						type:
							"string", format:
							"uri"
					}, insecureSkipVerify: type:
						"boolean", telegraf: type:
						"string", token: type:
						"string", username: type:
						"string", password: type:
						"string", sharedSecret: type:
						"string", metaUrl: {
						type:
							"string", format:
							"uri"
				...
				properties: {
					name: {
						...
						type:
							"string", description:
							"The type of the metrics to be parsed.", enum: [
							"prometheus",
						]
					}
					url: {
						type:
							"string", description:
							"The URL of the metrics endpoint.", example:
						...
						type:
							"boolean", description:
							"Skip TLS verification on endpoint.", default:
							false
					}
				}
				...
				allOf: [{
					$ref:
						"#/components/schemas/ScraperTargetRequest"
				}, {
					type:
						"object", properties: {
						id: {
				...
				properties: configurations: {
					type:
						"array", items: $ref:
						"#/components/schemas/ScraperTargetResponse"
				}
			}, MetadataBackup: {
				type: "object"
				properties: {
					kv: {
						...
						"#/components/schemas/BucketMetadataManifests"
				}, required: [
					"kv",
					"sql",
					"buckets",
			...
			BucketMetadataManifest: {
				...
				properties: {
					organizationID: type:
						"string", organizationName: type:
						"string", bucketID: type:
						"string", bucketName: type:
						"string", description: type:
						"string", defaultRetentionPolicy: type:
						"string", retentionPolicies: $ref:
						"#/components/schemas/RetentionPolicyManifests"
				}, required: [
					"organizationID",
					"organizationName",
					"bucketID",
			...
			RetentionPolicyManifest: {
				...
				properties: {
					name: type:
						...
						"#/components/schemas/ShardGroupManifests", subscriptions: $ref:
						"#/components/schemas/SubscriptionManifests"
				}, required: [
					"name",
					"replicaN",
					"duration",
			...
			ShardGroupManifest: {
				...
				properties: {
					id: {
						...
						"#/components/schemas/ShardManifests"
				}, required: [
					"id",
					"startTime",
					"endTime",
			...
			ShardManifest: {
				...
				properties: {
					id: {
						...
						"#/components/schemas/ShardOwners"
				}, required: [
					"id",
					"shardOwners",
				]
			...
			RestoredBucketMappings: {
				...
				properties: {
					id: {
						description:
							"New ID of the restored bucket", type:
							"string"
					}, name: type:
						"string", shardMappings: $ref:
						"#/components/schemas/BucketShardMappings"
				}, required: [
					"id",
					"name",
					"shardMappings",
