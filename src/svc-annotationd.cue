...
"svc-annotationd": {
	...
	paths: {
		"/annotations": $ref: "./svc/annotationd/paths/annotations.yml"
		"/annotations/{annotationID}": $ref: "./svc/annotationd/paths/annotation.yml"
		"/streams": $ref: "./svc/annotationd/paths/streams.yml"
	...
	components: {
		...
		schemas: {
			...
			AnnotationResponse: $ref: "./svc/annotationd/schemas/AnnotationResponse.yml"
